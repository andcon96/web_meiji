        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('checkcycle') }}" method="POST" class="dropzone needsclick">
                            @csrf
                            <div class="dz-message needsclick">
                                Drop files here or click to upload
                            </div>
                        </form>
                        <form action="{{ route('confirmcycle') }}" method="POST">
                            @csrf
                            @method('POST')
                            <div class="col-12 mt-4">
                                ...
                                <div class="d-flex mt-3">
                                    ...
                                    &nbsp; -->
                                    <button type="submit" class="btn btn-info pl-3" id="btnSubmit" >
