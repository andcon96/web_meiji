...
<tr>
    <td data-label="Schedule Prefix">{{ $prefix->other_ship_schedule_prefix }}</td>
    <td data-label="Sequence">{{ $prefix->other_ship_schedule_running_nbr }}</td>
    <td data-label="Action">
        <a href="{{ route('otherShipmentSchedulePrefix.edit', $prefix->id) }}" class="editdata" id='editdata'>
