...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <h5 class="card-header">Upload Item Location</h5>
                    <div class="card-body">
                        <form action="{{ route('checkFileUploadItemLocation') }}" method="POST" class="dropzone needsclick">
                            @csrf
                            <div class="dz-message needsclick">
                                Drop files here or click to upload
                            </div>
                        </form>
                        <form action="{{ route('confirmFileUploadItemLocation') }}" method="POST">
                            @csrf
                            @method('POST')
