...
@section('content')
    <div class="container">
        <form action="{{ route('prefix.update', $prefix->id) }}" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <input type="hidden" name="u_id" id="u_id" value="{{ $prefix->id }}">
            <div class="card mb-4">
                <h5 class="card-header">Edit prefix</h5>
                <div class="card-body">
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" value="{{ $prefix->prefix_receipt }}"
                                id="prefixReceipt" name="prefixReceipt" required />
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="number" id="runningNbrReceipt" name="runningNbrReceipt"
                                value="{{ $prefix->running_nbr_receipt }}" required />
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" value="{{ $prefix->prefix_buku_penerimaan }}"
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="number" id="runningNbrBukuPenerimaan"
                                name="runningNbrBukuPenerimaan" value="{{ $prefix->running_nbr_buku_penerimaan }}"
                                required />
                        </div>
                    </div>
