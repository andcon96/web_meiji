...
@section('content')
    <div class="container">
        <form action="{{ route('connections.store') }}" method="POST" enctype="multipart/form-data">
            ...
            @csrf
            <div class="card mb-4">
                <h5 class="card-header">Create Connection</h5>
                <div class="card-body">
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" value="{{ old('wsaURL') }}" id="wsaURL"
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" value="{{ old('wsaPath') }}" id="wsaPath"
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" value="{{ old('qxURL') }}" id="qxURL"
                    ...
                    {{-- <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" value="{{old('qxPath')}}" id="qxPath" name="qxPath" />
                        </div>
                    </div> --}}
