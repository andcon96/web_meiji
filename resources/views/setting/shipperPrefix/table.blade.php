...
<tr>
    <td data-label="Schedule Prefix">{{ $prefix->shipper_prefix }}</td>
    <td data-label="Sequence">{{ $prefix->shipper_number }}</td>
    <td data-label="Action">
        <a href="{{ route('shipperPrefix.edit', $prefix->id) }}" class="editdata" id='editdata'>
