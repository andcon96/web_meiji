...
@section('content')
            ...
            <div class="dataTables_wrapper dt-bootstrap5 no-footer">
                ...
                <div class="card-datatable table-responsive">
                    <table id="dataTable" class="dt-responsive table border-top">
                        ...
                        <tbody>
                            @include('setting.PicklistPrefix.table')
                        </tbody>
                        <tfoot>
                            <tr>
                                <th>Picklist Prefix</th>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <form action="{{ route('deletePicklistPrefix') }}" id="deleteForm" method="POST" enctype="multipart/form-data">
                @method('POST')
                @csrf
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', '.deletedata', function() {
                ...
                $('#prefixTitle').empty().html('Picklist Prefix');
                $('#d_id').val(prefixID);
