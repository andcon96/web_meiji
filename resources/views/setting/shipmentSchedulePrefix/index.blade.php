...
@section('content')
            ...
            <div class="dataTables_wrapper dt-bootstrap5 no-footer">
                <div class="card-header flex-column flex-md-row py-1">
                    ...
                    <div class="dt-action-buttons text-end pt-3 pt-md-0">
                        <div class="dt-buttons btn-group flex-wrap">
                            <form action="{{ route('shipmentSchedulePrefix.create') }}" method="GET" enctype="multipart/form-data">
                ...
                <div class="card-datatable table-responsive">
                    <table id="dataTable" class="dt-responsive table border-top">
                        ...
                        <tbody>
                            @include('setting.shipmentSchedulePrefix.table')
                        </tbody>
                        <tfoot>
                            <tr>
                                <th>Shipment Schedule Prefix</th>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <form action="{{ route('deleteShipmentScedulePrefix') }}" id="deleteForm" method="POST" enctype="multipart/form-data">
                @method('POST')
                @csrf
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', '.deletedata', function() {
                ...
                $('#prefixTitle').empty().html('Shipment Schedule Prefix');
                $('#d_id').val(prefixID);
