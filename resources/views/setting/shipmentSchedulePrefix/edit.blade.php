...
@section('content')
<div class="container">
    <form action="{{ route('shipmentSchedulePrefix.update', $prefix->id) }}" method="POST" enctype="multipart/form-data">
        @method('PUT')
        @csrf
        <input type="hidden" name="u_id" id="u_id" value="{{ $prefix->id }}">
        <div class="card mb-4">
            <h5 class="card-header">Edit Shipment Schedule Prefix</h5>
            <div class="card-body">
                <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                        <input class="form-control" type="text" value="{{ $prefix->ship_schedule_prefix }}"
                            id="shipmentSchedulePrefix" name="shipmentSchedulePrefix" required />
                    </div>
                </div>
                <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                        <input class="form-control" type="number" value="{{ $prefix->ship_schedule_running_nbr }}"
