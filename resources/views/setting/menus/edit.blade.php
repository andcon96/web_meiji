...
@section('content')
    <div class="container">
        <form action="{{ route('menus.update', $menu->id) }}" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <input type="hidden" name="u_id" id="u_id" value="{{ $menu->id }}">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" value="{{ $menu->menu_name }}" id="menuName"
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" value="{{ $menu->menu_route }}" id="menuRoute"
                                name="menuRoute" />
                        </div>
                    </div>
                    {{-- <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                <div class="form-check mb-2">
                                    <input name="hasApproval" class="form-check-input" type="radio"
                                        value="Yes" id="collapsible-hasApproval-yes" {{$menu->has_approval == 'Yes' ? 'checked' : ''}} />
                                ...
                                <div class="form-check">
                                    <input name="hasApproval" class="form-check-input" type="radio"
                                        value="No" id="collapsible-hasApproval-no" {{$menu->has_approval == 'No' ? 'checked' : ''}} />
