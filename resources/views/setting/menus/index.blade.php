...
@section('content')
                ...
                <div class="card-header flex-column flex-md-row py-1">
                    ...
                    <div class="dt-action-buttons text-end pt-3 pt-md-0">
                        <div class="dt-buttons btn-group flex-wrap">
                            <form action="{{ route('menus.create') }}" method="GET" enctype="multipart/form-data">
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <form action="{{ route('deleteMenu') }}" id="deleteForm" method="POST" enctype="multipart/form-data">
                @method('POST')
                @csrf
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', '.deleteMenu', function() {
                let menuStr = $(this).attr('data-menu');
