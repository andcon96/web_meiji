...
class QxtendServices
{
    ...
    public function qxPurchaseOrderReceipt($ponbr, $line, $lotSerialQty, $um, $site, $location, $lotserial,$expireddate)
    {
        $domain = Domain::first();
        $domainCode = $domain->domain ?? '';
        $qxwsa = Qxwsa::firstOrFail();
        ...
        $qdocbody = '<purchaseOrderReceive>
                            ...
                            <lineDetail>
                                    ...
                                    <chgExpire>'.$expireddate.'</chgExpire>
...
$qdocHead = '<soapenv:Envelope xmlns="urn:schemas-qad-com:xml-services" xmlns:qcom="urn:schemas-qad-com:xml-services:common" xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:wsa="http://www.w3.org/2005/08/addressing">
    ...
    public function qxTransferSingleItemTransfer($part, $qtyoh, $sitefrom, $siteto, $locfrom, $locto, $lotfrom, $lotto, $buildingfrom, $buildingto, $levelfrom, $levelto, $binfrom, $binto)
    {
        $domain = Domain::first();
        $domainCode = $domain->domain ?? '';
        $qxwsa = Qxwsa::firstOrFail();
